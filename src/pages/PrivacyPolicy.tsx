...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <SEO
        title="Privacy Policy - PrioLab"
        description="Learn about PrioLab's privacy practices, data collection policies, and how we protect your information when using our issue prioritization platform."
        url="/privacy"
      />
      {/* Header */}
